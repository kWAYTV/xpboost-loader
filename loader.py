...
{Fore.MAGENTA}════════════════════════════════════════════════════════════════════════════════════════════════{Fore.RESET}
 ____ ____ ____ ____ ____ ____ ____ ____ ____ ____ ____ _________ ____ ____ ____ ____ ____ ____ 
||X |||P |||B |||O |||O |||S |||T |||. |||L |||U |||A |||       |||L |||O |||A |||D |||E |||R ||
||__|||__|||__|||__|||__|||__|||__|||__|||__|||__|||__|||_______|||__|||__|||__|||__|||__|||__||
|/__\|/__\|/__\|/__\|/__\|/__\|/__\|/__\|/__\|/__\|/__\|/_______\|/__\|/__\|/__\|/__\|/__\|/__\|
{Fore.MAGENTA}════════════════════════════════════════════════════════════════════════════════════════════════{Fore.RESET}
\n\n
{Fore.MAGENTA}╭───────────────╮{Fore.RESET}
...
def config_filled():
    ...
    if filled == False and sandPath == "null":
        ...
        while unset == True:
            ...
            update = {
                "sandboxie_path": new_sandPath, "steam_path": steamPath, "bypass_path": bypassPath,
    ...
    if filled == False and steamPath == "null":
        ...
        while unset == True:
            ...
            update = {
                "sandboxie_path": sandPath, "steam_path": new_steamPath, "bypass_path": bypassPath,
             "bot1": {"username": bot1_user, "password": bot1_pass, "box": bot1_box},
             "bot2": {"username": bot2_user, "password": bot2_pass, "box": bot2_box},
             "bot3": {"username": bot3_user, "password": bot3_pass, "box": bot3_box},
             "main": {"username": main_user, "password": main_pass}
    ...
    if filled == False and bypassPath == "null":
        ...
        while unset == True:
            ...
            new_bypassPath = input()

            update = {
                "sandboxie_path": sandPath, "steam_path": steamPath, "bypass_path": new_bypassPath,
             "bot1": {"username": bot1_user, "password": bot1_pass, "box": bot1_box},
             "bot2": {"username": bot2_user, "password": bot2_pass, "box": bot2_box},
             "bot3": {"username": bot3_user, "password": bot3_pass, "box": bot3_box},
             "main": {"username": main_user, "password": main_pass}
    ...
    if filled == False and bot1_user == "null":
        ...
        while unset == True:
            ...
            update = {
             ...
             "bot1": {"username": new_bot1_user, "password": bot1_pass, "box": bot1_box},
             "bot2": {"username": bot2_user, "password": bot2_pass, "box": bot2_box},
             "bot3": {"username": bot3_user, "password": bot3_pass, "box": bot3_box},
             "main": {"username": main_user, "password": main_pass}
             }
    ...
    if filled == False and bot1_pass == "null":
        ...
        while unset == True:
            ...
            update = {
                "sandboxie_path": sandPath, "steam_path": steamPath, "bypass_path": bypassPath,
             "bot1": {"username": bot1_user, "password": new_bot1_pass, "box": bot1_box},
             "bot2": {"username": bot2_user, "password": bot2_pass, "box": bot2_box},
             "bot3": {"username": bot3_user, "password": bot3_pass, "box": bot3_box},
             "main": {"username": main_user, "password": main_pass}
             }
    ...
    if filled == False and bot1_box == "null":
        ...
        while unset == True:
            ...
            update = {
                "sandboxie_path": sandPath, "steam_path": steamPath, "bypass_path": bypassPath,
             "bot1": {"username": bot1_user, "password": bot1_pass, "box": new_bot1_box},
             "bot2": {"username": bot2_user, "password": bot2_pass, "box": bot2_box},
             "bot3": {"username": bot3_user, "password": bot3_pass, "box": bot3_box},
             "main": {"username": main_user, "password": main_pass}
             }
    ...
    if filled == False and bot2_user == "null":
        ...
        while unset == True:
            ...
            update = {
                "sandboxie_path": sandPath, "steam_path": steamPath, "bypass_path": bypassPath,
             "bot1": {"username": bot1_user, "password": bot1_pass, "box": bot1_box},
             "bot2": {"username": new_bot2_user, "password": bot2_pass, "box": bot2_box},
             "bot3": {"username": bot3_user, "password": bot3_pass, "box": bot3_box},
             "main": {"username": main_user, "password": main_pass}
             }
            config.update(update)
    ...
    if filled == False and bot2_pass == "null":
        ...
        while unset == True:
            ...
            update = {
                "sandboxie_path": sandPath, "steam_path": steamPath, "bypass_path": bypassPath,
             "bot1": {"username": bot1_user, "password": bot1_pass, "box": bot1_box},
             "bot2": {"username": bot2_user, "password": new_bot2_pass, "box": bot2_box},
             "bot3": {"username": bot3_user, "password": bot3_pass, "box": bot3_box},
             "main": {"username": main_user, "password": main_pass}
             }
            config.update(update)
    ...
    if filled == False and bot2_box == "null":
        ...
        while unset == True:
            ...
            update = {
                "sandboxie_path": sandPath, "steam_path": steamPath, "bypass_path": bypassPath,
             "bot1": {"username": bot1_user, "password": bot1_pass, "box": bot1_box},
             "bot2": {"username": bot2_user, "password": bot2_pass, "box": new_bot2_box},
             "bot3": {"username": bot3_user, "password": bot3_pass, "box": bot3_box},
             "main": {"username": main_user, "password": main_pass}
             }
            config.update(update)
    ...
    if filled == False and bot3_user == "null":
        ...
        while unset == True:
            ...
            update = {
             ...
             "bot1": {"username": bot1_user, "password": bot1_pass, "box": bot1_box},
             "bot2": {"username": bot2_user, "password": bot2_pass, "box": bot2_box},
             "bot3": {"username": new_bot3_user, "password": bot3_pass, "box": bot3_box},
             "main": {"username": main_user, "password": main_pass}
             }
            config.update(update)
            with open("config.json", "w") as jsfile:
    ...
    if filled == False and bot3_pass == "null":
        ...
        while unset == True:
            ...
            update = {
             ...
             "bot1": {"username": bot1_user, "password": bot1_pass, "box": bot1_box},
             "bot2": {"username": bot2_user, "password": bot2_pass, "box": bot2_box},
             "bot3": {"username": bot3_user, "password": new_bot3_pass, "box": bot3_box},
             "main": {"username": main_user, "password": main_pass}
             }
            config.update(update)
            with open("config.json", "w") as jsfile:
    ...
    if filled == False and bot3_box == "null":
        ...
        while unset == True:
            ...
            update = {
             ...
             "bot1": {"username": bot1_user, "password": bot1_pass, "box": bot1_box},
             "bot2": {"username": bot2_user, "password": bot2_pass, "box": bot2_box},
             "bot3": {"username": bot3_user, "password": bot3_pass, "box": new_bot3_box},
             "main": {"username": main_user, "password": main_pass}
             }
            config.update(update)
            with open("config.json", "w") as jsfile:
    ...
    if filled == False and main_user == "null":
        ...
        while unset == True:
            ...
            update = {
             ...
             "bot2": {"username": bot2_user, "password": bot2_pass, "box": bot2_box},
             "bot3": {"username": bot3_user, "password": bot3_pass, "box": bot3_box},
             "main": {"username": new_main_user, "password": main_pass}
             }
            config.update(update)
            with open("config.json", "w") as jsfile:
                json.dump(config, jsfile)
    ...
    if filled == False and main_pass == "null":
        ...
        while unset == True:
            ...
            update = {
             ...
             "bot2": {"username": bot2_user, "password": bot2_pass, "box": bot2_box},
             "bot3": {"username": bot3_user, "password": bot3_pass, "box": bot3_box},
             "main": {"username": main_user, "password": new_main_pass}
             }
            config.update(update)
            with open("config.json", "w") as jsfile:
                json.dump(config, jsfile)
...
def start():
    ...
    if exists == True and filled == True:
        ...
        slow_type(Fore.RED + "Error: " + Style.RESET_ALL + "Something went wrong! Closing...",0.001,)
        exit()
