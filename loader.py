...
def start():
    ...
    if exists == True and filled == True:
        ...
        slow_type(
            Fore.RED + "Error: " + Style.RESET_ALL + "Something went wrong! Closing...",
            0.001,
        )
        exit()
